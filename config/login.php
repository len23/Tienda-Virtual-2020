<?php 
  ...
  if(!isset($_COOKIE['user_id'])){ //Revisa si no esta establecida la cookie
    if(isset($_POST['submit'])){ //Revisa si no se ha hecho el submit
      ...
      echo '<p>Ingrese usuario o contrasena para ingresa</p>';
    }
  }
?>